...
* 数据库系统 [https://github.com/cmu-db/peloton](https://github.com/cmu-db/peloton)
* 关系数据库 [https://github.com/dbcg/dataphor](https://github.com/dbcg/dataphor)
* 自建数据库 [https://segmentfault.com/a/1190000042613900](https://segmentfault.com/a/1190000042613900)
* SQL机器学习 [https://maxhalford.github.io/blog/ogd-in-sql](https://maxhalford.github.io/blog/ogd-in-sql)
* 数据库架构 [https://lrita.github.io/images/posts/database/Architecture-of-a-Database-System.pdf](https://lrita.github.io/images/posts/database/Architecture-of-a-Database-System.pdf)
* 元数据代理 [https://github.com/expediagroup/waggle-dance](https://github.com/expediagroup/waggle-dance)
* 数据库教程 [https://dunwu.github.io/db-tutorial](https://dunwu.github.io/db-tutorial)
* 查询优化器 [https://zhuanlan.zhihu.com/p/680046526](https://zhuanlan.zhihu.com/p/680046526)
* 数据倾斜 [https://my.oschina.net/u/4090830/blog/8670851](https://my.oschina.net/u/4090830/blog/8670851)
...
* 湖仓管理 [https://github.com/netease/amoro](https://github.com/netease/amoro)
* 数据库代理 [https://github.com/mariadb-corporation/maxscale](https://github.com/mariadb-corporation/maxscale)
* 数据库中间件 [https://github.com/lede-inc/cetus](https://github.com/lede-inc/cetus)
* 分布式数据库 [https://github.com/erikgrinaker/toydb](https://github.com/erikgrinaker/toydb)
* 分布式数据库 [https://github.com/citusdata/citus](https://github.com/citusdata/citus)
* 查询优化 [https://ossinsight.io/blog/reduce-query-latency](https://ossinsight.io/blog/reduce-query-latency)
* 分库分表 [https://segmentfault.com/a/1190000042897642](https://segmentfault.com/a/1190000042897642)
* TiKV快照 [https://mp.weixin.qq.com/s/fjPl6K8JkWqRSGnaH0hmgA](https://mp.weixin.qq.com/s/fjPl6K8JkWqRSGnaH0hmgA)
* 分库分表 [https://architecturenotes.co/database-sharding-explained](https://architecturenotes.co/database-sharding-explained)
* 分库分表 [https://segmentfault.com/a/1190000043952559](https://segmentfault.com/a/1190000043952559)
* 分布式数据库 [https://github.com/apsaradb](https://github.com/apsaradb)
...
* 单文件库 [https://github.com/lllyasviel/singlefiledb](https://github.com/lllyasviel/singlefiledb)
* SQL数据库 [https://github.com/libsql/sqld](https://github.com/libsql/sqld)
* SQLite [https://www.bmpi.dev/dev/renaissance-sqlite](https://www.bmpi.dev/dev/renaissance-sqlite)
* 移动数据库 [https://github.com/nozbe/watermelondb](https://github.com/nozbe/watermelondb)
* SQLite内嵌 [https://sqlite.org](https://sqlite.org)
...
* 分析数据库 [https://github.com/splitgraph/seafowl](https://github.com/splitgraph/seafowl)
* 时序数据库 [https://github.com/man-group/arctic](https://github.com/man-group/arctic)
* 查询引擎 [https://github.com/apache/arrow-datafusion](https://github.com/apache/arrow-datafusion)
* 数据分析 [https://github.com/tabixio/tabix](https://github.com/tabixio/tabix)
* 分析型数据库 [https://github.com/greenplum-db/postgres](https://github.com/greenplum-db/postgres)
* 分析数据库 [https://github.com/apache/doris](https://github.com/apache/doris)
* 时序数据库 [https://github.com/greptimeteam/greptimedb](https://github.com/greptimeteam/greptimedb)
* 布隆过滤 [https://bohutang.me/2022/11/21/databend-xor-filter](https://bohutang.me/2022/11/21/databend-xor-filter)
* ClickHouse [https://www.cnblogs.com/traditional/p/15218565.html](https://www.cnblogs.com/traditional/p/15218565.html)
* 分析数据库 [https://github.com/search?q=clickhouse](https://github.com/search?q=clickhouse)
...
| BITMAP                  | 位图索引           |
| INVERTED                | 反向索引           |
* B+树索引 [https://mp.weixin.qq.com/s/Yb6OcCoM_Hhc4U8ESTYVbg](https://mp.weixin.qq.com/s/Yb6OcCoM_Hhc4U8ESTYVbg)
* SQL索引 [https://www.kawabangga.com/posts/3893](https://www.kawabangga.com/posts/3893)
...
## 主流数据库对比
* 数据库对比 [https://mp.weixin.qq.com/s/tRNedHlXmp7YfCqd21e5PA](https://mp.weixin.qq.com/s/tRNedHlXmp7YfCqd21e5PA)
...
- 数据扩展 [https://github.com/asg017/sqlite-xsv](https://github.com/asg017/sqlite-xsv)
- SQLite加速 [https://github.com/siara-cc/sqlite_blaster](https://github.com/siara-cc/sqlite_blaster)
- SQLite扩展 [https://github.com/0x6b/libgsqlite](https://github.com/0x6b/libgsqlite)
- SQLite存储过程 [https://github.com/aergoio/sqlite-stored-procedures](https://github.com/aergoio/sqlite-stored-procedures)
- 向量搜索 [https://github.com/asg017/sqlite-vss](https://github.com/asg017/sqlite-vss)
- SQLite封装 [https://github.com/stephencelis/sqlite.swift](https://github.com/stephencelis/sqlite.swift)
- 分布式DB [https://github.com/losfair/mvsqlite](https://github.com/losfair/mvsqlite)
- DB复制 [https://github.com/superfly/litefs](https://github.com/superfly/litefs)
- DB压缩 [https://github.com/phiresky/sqlite-zstd](https://github.com/phiresky/sqlite-zstd)
- DB扩展 [https://github.com/asg017/sqlite-lines](https://github.com/asg017/sqlite-lines)
- SQLite扩展 [https://github.com/nalgeon/sqlean](https://github.com/nalgeon/sqlean)
- SQLite存储 [https://github.com/litements/s3sqlite](https://github.com/litements/s3sqlite)
- SQLite浏览器 [https://github.com/rhashimoto/wa-sqlite](https://github.com/rhashimoto/wa-sqlite)
- 爬虫数据库 [https://github.com/florents-tselai/warcdb](https://github.com/florents-tselai/warcdb)
- SQLite图 [https://gitlab.com/Screwtapello/sqlite-schema-diagram](https://gitlab.com/Screwtapello/sqlite-schema-diagram)
- SQLite源码 [https://huili.github.io/index.html](https://huili.github.io/index.html)
- SQLite资源 [https://github.com/lichuang/awesome-sqlite](https://github.com/lichuang/awesome-sqlite)
- SQLite复制 [https://github.com/lichuang/replited](https://github.com/lichuang/replited)
- SQLite数据库 [https://github.com/tursodatabase/limbo](https://github.com/tursodatabase/limbo)
