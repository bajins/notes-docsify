...
* [https://github.com/cjcliffe](https://github.com/cjcliffe)
* [https://github.com/pothosware](https://github.com/pothosware)
* [https://github.com/dustinbowers/QuadRF](https://github.com/dustinbowers/QuadRF)
* 设备发现 [https://github.com/Dyneteq/reconya](https://github.com/Dyneteq/reconya)
...
- 电路仿真 [https://github.com/pfalstad/circuitjs1](https://github.com/pfalstad/circuitjs1)
- 条码服务 [https://github.com/markusressel/barcode-server](https://github.com/markusressel/barcode-server)
- 无障碍接口 [https://github.com/linuxa11y/iaccessible2](https://github.com/linuxa11y/iaccessible2)
- 硬件翻译 [https://github.com/aappleby/metron](https://github.com/aappleby/metron)
- IoT网关 [https://github.com/edgenesis/shifu](https://github.com/edgenesis/shifu)
- 硬件信息 [https://github.com/lfreist/hwinfo](https://github.com/lfreist/hwinfo)
- Z-Wave [https://z-wavealliance.org/resources-overview](https://z-wavealliance.org/resources-overview)
...
* SCADA平台 [https://github.com/frangoteam/fuxa](https://github.com/frangoteam/fuxa)
...
* 裸机编程 [https://github.com/cpq/bare-metal-programming-guide](https://github.com/cpq/bare-metal-programming-guide)
* 硬件转接 [https://github.com/kcores/kcores-flexiblelom-adapter](https://github.com/kcores/kcores-flexiblelom-adapter)
* 闪存驱动 [https://github.com/armink/sfud](https://github.com/armink/sfud)
* 浏览器刷固件 [https://github.com/xingrz/web-esptool](https://github.com/xingrz/web-esptool)
* ESP开发框架 [https://github.com/espressif/esp-idf](https://github.com/espressif/esp-idf)
* 嵌入式终端 [https://github.com/nevermindzzt/letter-shell](https://github.com/nevermindzzt/letter-shell)
* RISC-V核 [https://github.com/liangkangnan/tinyriscv](https://github.com/liangkangnan/tinyriscv)
* 嵌入式GUI [https://github.com/lvgl/lvgl](https://github.com/lvgl/lvgl)
* 磁条伪造 [https://github.com/samyk/magspoof](https://github.com/samyk/magspoof)
* 心率监测 [https://github.com/andreyk0/cardiac-monitor](https://github.com/andreyk0/cardiac-monitor)
* 嵌入式打印 [https://github.com/mickjc750/prnf](https://github.com/mickjc750/prnf)
* 嵌入式C库 [https://github.com/picolibc/picolibc](https://github.com/picolibc/picolibc)
* 系统开发 [https://github.com/rust-embedded/rust-raspberrypi-os-tutorials](https://github.com/rust-embedded/rust-raspberrypi-os-tutorials)
* 树莓派教程 [https://github.com/wxlscm/raspberry_tutorial](https://github.com/wxlscm/raspberry_tutorial)
* 能源监控 [https://openenergymonitor.org](https://openenergymonitor.org)
* 雷达硬件 [https://github.com/NawfalMotii79/PLFM_RADAR](https://github.com/NawfalMotii79/PLFM_RADAR)
* Rust嵌入式 [https://narukara.github.io/rust-on-esp-book-zh-cn](https://narukara.github.io/rust-on-esp-book-zh-cn)
* WiFi安全 [https://mp.weixin.qq.com/s/IR3t7lLATcuxYREl5VHnwQ](https://mp.weixin.qq.com/s/IR3t7lLATcuxYREl5VHnwQ)
* ESP32烧录 [https://esp.xingrz.me/#/studio](https://esp.xingrz.me/#/studio)
* 嵌入式Rust [https://logiase.github.io/The-Embedded-Rust-Book-CN](https://logiase.github.io/The-Embedded-Rust-Book-CN)
* 示波器 [https://csurgay.com/syggen](https://csurgay.com/syggen)
* 物联网平台 [https://github.com/thingspanel](https://github.com/thingspanel)
* ARM嵌入式 [https://github.com/linaro](https://github.com/linaro)
* 嵌入式开发 [https://github.com/bd4sur](https://github.com/bd4sur)
* 实时操作系统 [https://github.com/eclipse-threadx](https://github.com/eclipse-threadx)
* 水下机器人 [https://github.com/murexrobotics](https://github.com/murexrobotics)
* 嵌入式开发板 [https://github.com/embedfire](https://github.com/embedfire)
* 嵌入式Lua [https://github.com/elua](https://github.com/elua)
* A/B分区升级 [https://zhuanlan.zhihu.com/p/554132450](https://zhuanlan.zhihu.com/p/554132450)
* FOTA升级 [https://blog.csdn.net/weixin_42913061/article/details/118363867](https://blog.csdn.net/weixin_42913061/article/details/118363867)
* 嵌入式代码库 [https://blog.csdn.net/u011559046/article/details/80172809](https://blog.csdn.net/u011559046/article/details/80172809)
...
- 串口测试 [https://github.com/wh201906/serialtest](https://github.com/wh201906/serialtest)
- 串口绘图 [https://github.com/hyozd/serialplot](https://github.com/hyozd/serialplot)
- NMEA解析 [https://github.com/adrianmo/go-nmea](https://github.com/adrianmo/go-nmea)
- 串口调试 [https://gitee.com/ErichMoonan/serial-master](https://gitee.com/ErichMoonan/serial-master)
...
* [https://github.com/java-native/jssc](https://github.com/java-native/jssc)
...
* 外设管理 [https://github.com/yume-chan/g-web](https://github.com/yume-chan/g-web)
* 浏览器ADB [https://github.com/yume-chan/ya-webadb](https://github.com/yume-chan/ya-webadb)
...
- Windows
    - WinSpool
        - EMF (Enhanced Metafile，增强型图元文件)
        - RAW（原始数据）
            - PCL (Printer Command Language) HP公司
            - PS (PostScript) Adobe公司
            - UFR II (Ultra Fast Rendering) 佳能公司
            - ESC/POS Escape/POS 爱普生（Epson）公司
            - ZPL Zebra Programming Language 斑马技术（Zebra Technologies）
            - TSPL TSC Printer Language（亦称 TSPL/TSPL2 TSC Auto ID Technology（台湾立象）
            - EPL Eltron Programming Language Eltron（后被Zebra收购）
            - PDF
            - TIFF Tag Image File Format 光栅图像文件格式（位图+标签容器） Aldus（现Adobe）
            - Ghostscript
        - TEXT（ASCII纯文本）
        - XPS (XML Paper Specification / XPS_PASS)
    - GDI (Graphics Device Interface)
    - WinRT Windows.Data.Pdf
    - Windows.Graphics.Printing
    - DirectX/Direct2D
    - PrintTicket 和 PrintCapabilities API (PT/PC)
- 打印机硬件支持
    - Raw (printer-job-language Port 9100) 打印机通信协议 TCP/IP 端口直接打印
    - LPR（Line Printer Daemon Protocol，端口515）
    - IPP 协议 (Internet Printing Protocol，端口631) 互联网打印协议
...
* [https://www.zebra.cn/cn/zh/software/printer-software.html](https://www.zebra.cn/cn/zh/software/printer-software.html)
...
* [https://gitee.com/gscloudplugin/gscloudplugin](https://gitee.com/gscloudplugin/gscloudplugin)
    * [https://github.com/gscloudplugin/gscloudplugin](https://github.com/gscloudplugin/gscloudplugin)
    * [http://www.c-lodop.com](http://www.c-lodop.com)
        * [https://www.lodop.net](https://www.lodop.net)
...
* 蓝牙打印 [https://github.com/thon-ju/bluetooth_print](https://github.com/thon-ju/bluetooth_print)
...
- 机器人框架 [https://github.com/hybridgroup/gobot](https://github.com/hybridgroup/gobot)
...
* OLE Automation [https://github.com/eclipse-platform/eclipse.platform.swt](https://github.com/eclipse-platform/eclipse.platform.swt)
    * [https://github.com/swt-initiative31](https://github.com/swt-initiative31)
...
* [https://github.com/qzind/tray](https://github.com/qzind/tray)
    * [https://github.com/micwallace/webprint](https://github.com/micwallace/webprint)
    * [https://github.com/xenithpulse/xp-thermal-service](https://github.com/xenithpulse/xp-thermal-service)
...
- [https://github.com/parzibyte/ejemplos-javascript-plugin-v3](https://github.com/parzibyte/ejemplos-javascript-plugin-v3)
- [https://github.com/PrintNode](https://github.com/PrintNode)
- [https://github.com/NielsLeenheer/WebUSBReceiptPrinter](https://github.com/NielsLeenheer/WebUSBReceiptPrinter)
- [https://github.com/lsongdev/node-escpos](https://github.com/lsongdev/node-escpos)
- [https://github.com/mike42/escpos-php](https://github.com/mike42/escpos-php)
