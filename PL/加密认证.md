...
* 权限控制 [https://github.com/casbin/casbin](https://github.com/casbin/casbin)
* 密文编辑器 [https://github.com/mozilla/sops](https://github.com/mozilla/sops)
* 加密示例 [https://github.com/raymiiorg/openssl-modern-cpp](https://github.com/raymiiorg/openssl-modern-cpp)
* 编码解码 [https://github.com/gchq/cyberchef](https://github.com/gchq/cyberchef)
* TLS教程 [https://github.com/bob-beck/libtls](https://github.com/bob-beck/libtls)
* TLS库 [https://github.com/mirleft/libnqsb-tls](https://github.com/mirleft/libnqsb-tls)
* TLS实现 [https://github.com/michaelforney/libtls-bearssl](https://github.com/michaelforney/libtls-bearssl)
* TLS加密库 [https://github.com/armmbed/mbedtls](https://github.com/armmbed/mbedtls)
* 加密库 [https://boringssl.googlesource.com/boringssl](https://boringssl.googlesource.com/boringssl)
* 安全库 [https://www.mozilla.org/projects/security/pki/nss](https://www.mozilla.org/projects/security/pki/nss)
* 加密剪贴板 [https://github.com/mihanentalpo/cryptboard.io](https://github.com/mihanentalpo/cryptboard.io)
* TLS库调研 [https://transactional.blog/blog/2022-database-tls-survey.html](https://transactional.blog/blog/2022-database-tls-survey.html)
* 身份认证平台 [https://gitee.com/topiam/eiam](https://gitee.com/topiam/eiam)
* HTTPS原理 [https://howhttps.works/zh/why-do-we-need-https](https://howhttps.works/zh/why-do-we-need-https)
* 密钥卸载 [https://mp.weixin.qq.com/s/660_EiV2KTR7pTvRJny_JA](https://mp.weixin.qq.com/s/660_EiV2KTR7pTvRJny_JA)
* 实用密码学 [https://thiscute.world/posts/practical-cryptography-basics-1](https://thiscute.world/posts/practical-cryptography-basics-1)
* 密码学 [https://github.com/nakov/practical-cryptography-for-developers-book](https://github.com/nakov/practical-cryptography-for-developers-book)
* 密码学 [https://github.com/evian-zhang/introduction-to-modern-cryptography](https://github.com/evian-zhang/introduction-to-modern-cryptography)
* 加密库 [https://github.com/randombit/botan](https://github.com/randombit/botan)
* 加密入门 [https://github.com/crypto101/book](https://github.com/crypto101/book)
* 密码管理器 [https://github.com/dashlane](https://github.com/dashlane)
* 身份认证 [https://github.com/oktadev](https://github.com/oktadev)
* 加密库 [https://github.com/openpgpjs](https://github.com/openpgpjs)
* 安全组件 [https://dxr.mozilla.org/mozilla-central/source/security/manager](https://dxr.mozilla.org/mozilla-central/source/security/manager)
* TLS库 [https://git.causal.agency/libretls](https://git.causal.agency/libretls)
* 授权引擎 [https://github.com/openfga](https://github.com/openfga)
* TLS协议解析 [https://zhuanlan.zhihu.com/p/395907216](https://zhuanlan.zhihu.com/p/395907216)
...
* 认证网关 [https://github.com/aklaus/transparent-auth-gateway](https://github.com/aklaus/transparent-auth-gateway)
* 身份认证 [https://github.com/logto-io/logto](https://github.com/logto-io/logto)
* WebAuthn认证 [https://github.com/microsoft/webauthn](https://github.com/microsoft/webauthn)
* OAuth客户端 [https://github.com/cloudentity/oauth2c](https://github.com/cloudentity/oauth2c)
* 认证库 [https://github.com/nextauthjs/next-auth](https://github.com/nextauthjs/next-auth)
* 无密码认证 [https://fidoalliance.org/passkeys](https://fidoalliance.org/passkeys)
* OAuth专家 [https://aaronparecki.com](https://aaronparecki.com)
...
* JWT测试工具 [https://github.com/ticarpi/jwt_tool](https://github.com/ticarpi/jwt_tool)
* JWT认证 [https://segmentfault.com/a/1190000042267741](https://segmentfault.com/a/1190000042267741)
* JWT认证 [https://segmentfault.com/a/1190000043456300](https://segmentfault.com/a/1190000043456300)
...
* 编码工具 [https://gchq.github.io/CyberChef](https://gchq.github.io/CyberChef)
* Base64编码 [https://segmentfault.com/a/1190000044064279](https://segmentfault.com/a/1190000044064279)
* 加解密工具 [https://Leon406/ToolsFx](https://Leon406/ToolsFx)
...
- 轻量级加密算法
    - [Ascon](https://ascon.iaik.tugraz.at)
        ...
        - Ascon-XOF
        - Ascon-Hash
- 密钥交换 [https://github.com/schollz/pake](https://github.com/schollz/pake)
- 加密算法库 [https://github.com/istommao/cryptography](https://github.com/istommao/cryptography)
- 文件加密分割 [https://github.com/jesseduffield/horcrux](https://github.com/jesseduffield/horcrux)
- SSL库 [https://github.com/google/boringssl](https://github.com/google/boringssl)
- 文件加密 [https://github.com/filosottile/age](https://github.com/filosottile/age)
- 加密工具 [https://github.com/life4/enc](https://github.com/life4/enc)
- RSA加密 [https://github.com/rustcrypto/rsa](https://github.com/rustcrypto/rsa)
- TLS实现 [https://github.com/aws/s2n-tls](https://github.com/aws/s2n-tls)
- 密码强度 [https://github.com/rianhunter/zxcvbn-cpp](https://github.com/rianhunter/zxcvbn-cpp)
- 密码学生成 [https://github.com/mit-plv/fiat-crypto](https://github.com/mit-plv/fiat-crypto)
- 加密库 [https://github.com/originjs/crypto-js-wasm](https://github.com/originjs/crypto-js-wasm)
- 加密库 [https://github.com/jasypt/jasypt](https://github.com/jasypt/jasypt)
- 密码算法 [https://introspelliam.github.io/2018/03/26/crypto/常用于密码学中的算法](https://introspelliam.github.io/2018/03/26/crypto/常用于密码学中的算法)
- 加密算法 [https://github.com/teslamotors/liblithium](https://github.com/teslamotors/liblithium)
- TLS加密库 [https://github.com/mbed-tls/mbedtls](https://github.com/mbed-tls/mbedtls)
- LibreSSL [https://www.libressl.org](https://www.libressl.org)
- 密码学书籍 [https://cryptobook.nakov.com](https://cryptobook.nakov.com)
- TPM密钥 [https://ericchiang.github.io/post/tpm-keys](https://ericchiang.github.io/post/tpm-keys)
- 文本加密 [https://github.com/fzxx/XiangYue](https://github.com/fzxx/XiangYue)
- SSL/TLS [https://introspelliam.github.io/2018/03/20/crypto/%E6%B7%B1%E5%BA%A6%E8%A7%A3%E8%AF%BBSSL-TLS%E5%AE%9E%E7%8E%B0](https://introspelliam.github.io/2018/03/20/crypto/%E6%B7%B1%E5%BA%A6%E8%A7%A3%E8%AF%BBSSL-TLS%E5%AE%9E%E7%8E%B0)
- 零知识证明 [https://aszepieniec.github.io/stark-brainfuck](https://aszepieniec.github.io/stark-brainfuck)
- 密码破解 [https://blog.csdn.net/qq_42893430/category_9101067.html](https://blog.csdn.net/qq_42893430/category_9101067.html)
- 加密库 [https://github.com/secretflow/yacl](https://github.com/secretflow/yacl)
- 零知识证明 [https://github.com/wtfacademy/wtf-zk](https://github.com/wtfacademy/wtf-zk)
- 机密计算框架 [https://www.oschina.net/project/awesome?columnId=47](https://www.oschina.net/project/awesome?columnId=47)
- TLS图解 [https://cangsdarm.github.io/illustrate/tls13](https://cangsdarm.github.io/illustrate/tls13)
- 因数分解工具 [https://sourceforge.net/projects/yafu](https://sourceforge.net/projects/yafu)
- TLS1.2图解 [https://cangsdarm.github.io/illustrate/tls12](https://cangsdarm.github.io/illustrate/tls12)
- 密钥存储库 [https://git.gnome.org/browse/libsecret](https://git.gnome.org/browse/libsecret)
- HTTPS握手 [https://blog.csdn.net/weixin_44478659/article/details/121129285](https://blog.csdn.net/weixin_44478659/article/details/121129285)
...
- Whirlpool
- Gost3411
- 编译期哈希 [https://github.com/hanickadot/cthash](https://github.com/hanickadot/cthash)
- 哈希算法 [https://github.com/cyan4973/xxhash](https://github.com/cyan4973/xxhash)
- 密码哈希 [https://github.com/dcodeio/bcrypt.js](https://github.com/dcodeio/bcrypt.js)
- 哈希碰撞 [https://github.com/corkami/collisions](https://github.com/corkami/collisions)
- SHA256 [https://sha256algorithm.com](https://sha256algorithm.com)
...
- 证书管理 [https://github.com/caddyserver/certmagic](https://github.com/caddyserver/certmagic)
- 根证书 [https://pki.goog/roots.pem](https://pki.goog/roots.pem)
- 证书管理 [https://searchfox.org/mozilla-central/rev/0fec57c05d3996cc00c55a66f20dd5793a9bfb5d/security/manager/ssl/EnterpriseRoots.cpp](https://searchfox.org/mozilla-central/rev/0fec57c05d3996cc00c55a66f20dd5793a9bfb5d/security/manager/ssl/EnterpriseRoots.cpp)
- 本地证书 [https://github.com/filosottile/mkcert](https://github.com/filosottile/mkcert)
- SSL证书 [https://github.com/danbao/auto-ssl](https://github.com/danbao/auto-ssl)
